...
var muon = muoncore.create("nodejs-client", amqpurl);
...
muon.requestWithAuth("rpc://stream-test/in", {}, {
  provider:"aether", token:"AWSEOMEISASAWESOMEDOES"
}).then((ret) => console.dir(ret)).catch((er) => console.dir(er))
